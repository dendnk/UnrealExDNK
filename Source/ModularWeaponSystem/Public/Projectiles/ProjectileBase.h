...
protected:
    ...
    // Hook for project-specific AoE damage application on explosion. No-op by default — this plugin has no
    // notion of valid AoE targets; see overrides for the actual target discovery.
